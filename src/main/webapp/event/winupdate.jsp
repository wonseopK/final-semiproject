...
<div class="row">
 ...
 <div class="col-md-8">
  ...
  <form action="event/winupdateaction.jsp" method="post">
   <div class="table table-responsive">
    ...
    <tr>
     ...
     <td colspan="3"><input type="text"  class="form-control" id="subject" name="subject" value="<%=dto.getSubject() %>"></td>
    </tr>
    ...
    <tr>
     ...
     <td colspan="4"  class="text-center">
      ...
      <input type="submit" value="글수정" onclick="submitContents(this)" class="btn btn-warning">
